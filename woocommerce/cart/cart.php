    ...
    <!-- !!!!!!     COUNTDOWN    TIMER   !!! --!>
                ...
                <div class="wc-reserve-note" id="wc-reserve-note" role="status" aria-live="polite">
                  ...
                  <span class="wc-reserve-note__text">
                   Vă rugăm să vă grăbiți! Cineva tocmai a comandat unul dintre produsele din coșul dvs. Rezervarea este valabilă pentru <strong id="wc-reserve-timer">10:00</strong> minute.
                  </span>
                </div>
