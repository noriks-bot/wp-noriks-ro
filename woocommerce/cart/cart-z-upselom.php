    ...
    <!-- !!!!!!     COUNTDOWN    TIMER   !!! --!>
                ...
                <div class="wc-reserve-note" id="wc-reserve-note" role="status" aria-live="polite">
                  ...
                  <span class="wc-reserve-note__text">
                    Vă rugăm să vă grăbiți! Cineva tocmai a comandat unul dintre produsele din coșul dvs. 
                    Rezervarea este valabilă pentru <strong id="wc-reserve-timer">10:00</strong> minute.
                  </span>
                </div>
...
<div class="upsell-wrap <?php echo $upsell_in_cart ? 'is-added' : ''; ?>"
  ...
  <div class="upsell-card">
      ...
      <div class="gck-popular-badge">Ofertă specială <img draggable="false" role="img" class="emoji" alt="🔥" src="https://s.w.org/images/core/emoji/17.0.2/svg/1f525.svg"></div>
      ...
      try{
        ...
        if (checkbox.checked) {
          ...
          if (!res.ok || data?.error) {
            checkbox.checked = false;
            syncAddedUI(false);
            alert('Nu pot adăuga produsul. Verificați opțiunile selectate (variațiile) și disponibilitatea.');
            setBusy(false);
            return;
          }
