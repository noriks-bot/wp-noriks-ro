...
<style>
 ...
 <section class=" features2" aria-label="Prednosti">
  ...
  <img src="/ro/wp-content/themes/noriks/img/cod_icon_.png" alt="Customer Support Icon" class="feature__icon info-icon">
          <p class="feature__text">Ramburs la livrare</p>
        </div>
...
<div class="shipping-box">
  ...
  <p class="shipping-sub">
    Comandați în următoarele <span id="midnight-countdown" class="countdown"></span>
  </p>
</div>
...
<br>
     ...
     <div class="accordion-item">
      ...
      <div class="accordion-content">
          ...
          <img src="https://noriks.com/ro/wp-content/uploads/2026/01/boxers_size_GR.png">
        ...
        <?php elseif(  $is_carape ): ?>
                  ...
                  <img src="https://noriks.com/ro/wp-content/uploads/2026/01/Nogavice_tabela_velikosti_GR.png">
                  
    <?php elseif(  $is_mixed_bundle ): ?>
    
     <img src="https://noriks.com/ro/wp-content/uploads/2025/09/noriks_tablica_gr.jpg">
