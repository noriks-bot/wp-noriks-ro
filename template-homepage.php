...
get_header(); ?>
  ...
  <div class="hero__media" aria-hidden="true">
    ...
    <img
      src="/ro/wp-content/themes/noriks/img/noriks-hero.jpeg"
      alt=""
    />
  </div>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Cumpărați pe colecții</h2>
  ...
  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/ro/shop/?filter_product_cat=t-shirts">
      <div class="collection-card__media">
        <img
          src="/ro/wp-content/themes/noriks/img/noriks-majice.jpeg"
...
Confort toată ziua. Fără să se ridice.
          </p>
        </div>
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/ro/shop/?filter_product_cat=boxers">
      <div class="collection-card__media">
        <img
          src="/ro/wp-content/themes/noriks/img/noriks-boksarice.jpeg"
          alt="V-neck t-shirt"
        />
      </div>
   ...
   Moi. Respirabile. De încredere.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/ro/product-category/bundles/">
      <div class="collection-card__media">
        <img
          src="/ro/wp-content/themes/noriks/img/noriks-kompleti.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          ...
          <p class="collection-card__desc">
Cel mai bun raport calitate-preț în set.
          </p>
        </div>
    ...
    <!-- Card 4 - Starter Pack -->
    <a class="collection-card" href="/ro/shop/?filter_product_cat=starter-pack">
      <div class="collection-card__media">
        <img
          src="/ro/wp-content/themes/noriks/img/starter-paket_.jpeg"
          alt="Long sleeve shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Pachet de start</h3>
           
           
          </div>
          <p class="collection-card__desc">
Încearcă NORIKS la un preț mai bun.
