...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Formatter for RON with 2 decimals
  ...
  function formatPrice(amount) {
    ...
    return ron.format(Math.round(amount * 100) / 100);
  }
...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      <span><a href="/ro/shop">Livrare gratuită pentru comenzi peste 150 lei</a></span>
      <span><a href="/ro/shop">30 de zile fără risc – încearcă fără griji</a></span>
      <!--<span><a href="/ro/shop">Ofertă de iarnă: Până la 70% reducere!</a></span>-->
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/ro/shop">Creați-vă pachetul</a>
                        <a href="/ro/product-category/tricka/">Pachete gata făcute</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/ro/product-category/boxerky-sastavi-paket/">Creați-vă pachetul</a>
                        <a href="/ro/product-category/boxerky/">Pachete gata făcute</a>
                    </div>
                    -->
                </div>
