...
$nhy_marquee = array(
  ...
  array( 'beskraj', 'Filtru permanent, bez zamjena' ),
...
<!-- ============ 2) Vezi cum face spumă ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap">
    <h2 class="nhy-h2 nhy-center">Vezi cum face spumă</h2>
    <p class="nhy-fizz-text">Privește bulele puternice care apar în timpul electrolizei — este infuzia curată de hidrogen în cea mai bună formă. Apa rămâne limpede și răcoritoare după fiecare ciclu.</p>
    <div class="nhy-fizz">
...
<!-- ============ 3) Putere antioxidantă, mai puține inflamații ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Putere antioxidantă, mai puține inflamații</h2>
      <p>Apa cu hidrogen este cunoscută pentru acțiunea antioxidantă și antiinflamatoare puternică, asociată în cercetări cu beneficii în peste 150 de afecțiuni.</p>
      <p>Studiile clinice au arătat și că trei sticle de apă cu hidrogen pot avea un efect antioxidant comparabil cu consumul a sute de fructe și legume.</p>
      <p class="nhy-note">Apa cu hidrogen este un supliment la hidratarea zilnică, nu un înlocuitor al tratamentului medical.</p>
    </div>
...
<section class="nhy-sec">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Povești reale ale utilizatorilor</h2>
  </div>
  <div class="nhy-wrap nhy-row2">
    ...
    <div class="nhy-copy">
      <ul class="nhy-stories">
        <li><strong>Recuperare cu mai multă energie</strong><span>„Nakon svakog treninga osjećam manje umora u mišićima. HydraH₂ mi je oporavak učinio jednostavnim."</span></li>
        <li><strong>Hidratare care se vede</strong><span>„Koža mi je punija i bolje hidrirana. Savršeno za svakodnevnu rutinu."</span></li>
        <li><strong>Practic și curat</strong><span>„Nema okusa plastike, punjenje preko USB-a je jednostavno. Moja svakodnevna boca."</span></li>
      </ul>
    </div>
  </div>
</section>

<!-- ============ 5) Beneficiile apei cu hidrogen ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Beneficiile apei cu hidrogen</h2>
  </div>
  <div class="nhy-wrap">
    <div class="nhy-perks">
      <div class="nhy-perk"><strong>Hidratare mai bună</strong><span>Îmbogățește apa cu hidrogen în concentrație ridicată pentru o hidratare optimă.</span></div>
      <div class="nhy-perk"><strong>Baterie reîncărcabilă</strong><span>Încărcarea USB în mai puțin de 60 de minute ține sticla pregătită toată ziua.</span></div>
      <div class="nhy-perk"><strong>Filtru permanent</strong><span>Filtrul integrat nu necesită înlocuire — îți economisește timp și bani.</span></div>
      <div class="nhy-perk"><strong>Cicluri rapide</strong><span>Alege un ciclu de 3 sau 10 minute pentru o doză de hidrogen personalizată.</span></div>
    </div>
  </div>
</section>

<!-- ============ 6) Producție avansată de hidrogen ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-media"><?php echo $nh_img('hyd-04-kako-radi.webp','PEM i SPE elektroliza — proizvodnja vodika'); ?></div>
    <div class="nhy-copy">
      <h2 class="nhy-h2">Producție avansată de hidrogen</h2>
      <p>Cu ajutorul electrolizei de vârf <strong>PEM și SPE</strong> NORIKS HYD produce până la <strong>3.000 ppb</strong> de hidrogen molecular în apă. Sticla din sticlă cu bază din oțel inoxidabil face ca apa să nu atingă niciodată plasticul, iar filtrul permanent al generatorului elimină grija întreținerii. Aerisirea automată evacuează gazele rămase, pentru o băutură curată și sigură.</p>
      <ul class="nhy-check">
        <li>Electrozi din titan cu strat de platină</li>
        <li>Hidrogen pur 99,99 %, produsele secundare ies prin aerisire</li>
        <li>Funcționează cu orice apă potabilă, inclusiv distilată</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Ești gata să duci hidratarea la alt nivel?</h2>
      <p>Alătură-te miilor de oameni care și-au îmbunătățit rutina de wellness cu apă bogată în hidrogen. Simte valul de energie, recuperarea mai bună și hidratarea care se vede.</p>
      <a class="nhy-cta" href="#bundle-selector">Comandă NORIKS HYD</a>
    </div>
