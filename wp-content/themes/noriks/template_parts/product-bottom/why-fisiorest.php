...
$fis_experts = array(
    array( 'img' => $fis_i.'fis-strucnjak-1.jpg', 'name' => 'Marina Popescu', 'role' => 'Terapeută de masaj certificată', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-2.jpg', 'name' => 'Ana Ionescu', 'role' => 'Fizioterapeută', 'org' => '' ),
    array( 'img' => $fis_i.'fis-strucnjak-3.jpg', 'name' => 'Ioana Georgescu', 'role' => 'Chiropracticiană', 'org' => '' ),
);
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      ...
      <p class="fis-exp-author"><strong>Marina Popescu</strong><br>Terapeută de masaj certificată</p>
    </div>
