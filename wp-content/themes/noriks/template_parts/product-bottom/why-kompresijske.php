...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Cum funcționează în practică</h2>
...
<section class="why-section knc-compare-section">
  <div class="knc-compare-wrap">
    <h2 class="knc-compare-title">NORIKS vs ceilalți</h2>
    <div class="knc-table-scroll">
      <table class="knc-table">
        <thead>
          <tr>
            <th class="knc-feat"></th>
            <th class="knc-comp">Ciorapi clasici<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">Ciorapi TV<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">Nr. 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Compresie medicală</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Fermoar pentru încălțare ușoară</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Încălțare de unul singur, fără ajutor</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Ciorapi compresivi">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        DE CE CIORAPI COMPRESIVI?
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Circulație mai bună, mai puțină oboseală</strong></p>
        <p class="description">Compresia graduală stimulează delicat fluxul sanguin către inimă, reduce senzația de greutate și oboseală în picioare și ajută picioarele să rămână ușoare chiar și în cele mai lungi zile.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Mai puțină umflătură</strong></p>
        <p class="description">Ideali pentru călătorii lungi, statul în picioare sau șezut îndelungat. Presiunea uniformă reduce retenția de lichide și umflarea gleznelor și a gambelor.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Un suport pe care îl simți</strong></p>
        <p class="description">Croiala anatomică ține ciorapul la locul lui, fără să strângă la partea de sus. O senzație de suport ferm, dar plăcut, pe tot parcursul zilei.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Ce spun clienții noștri</h2>
