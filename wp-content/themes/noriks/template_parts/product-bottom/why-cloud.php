 ...
 *   1. Recuperează diminețile pe care le credeai pierdute   11_jutra
 ...
 *   7. Nu toate pernele pentru genunchi sunt la fel                      05
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Diferența care se vede din prima noapte</h2>
      <p><strong>Fără pernă:</strong> piciorul de sus cade peste cel de jos, bazinul se răsucește, iar presiunea ajunge în zona lombară și în genunchi.</p>
      <p><strong>Cu NORIKS Cloud:</strong> picioarele rămân în linie cu șoldurile, greutatea se distribuie, iar punctele de presiune dispar.</p>
      <ul class="ncd-check">
        <li>Șolduri și genunchi în linie naturală</li>
        <li>Mai puțină presiune pe zona lombară</li>
        <li>Mai puțină foială în timpul nopții</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Începe să dormi mai bine chiar din seara asta</h2>
    <p class="ncd-sub">Simplu de folosit. <strong>Somn mai bun</strong> din prima noapte.</p>
  </div>
  <div class="ncd-wrap">
      ...
      <?php foreach ( $cd_steps as $i => $st ) : ?>
        <div class="ncd-step4">
          <div class="ncd-step4-ic">
            ...
            <span class="ncd-step4-b">Pasul <?php echo (int) $i + 1; ?></span>
          </div>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">De ce te trezești altfel cu NORIKS Cloud</h2>
    <p class="ncd-sub ncd-rate"><span class="ncd-stars">★★★★★</span> Evaluare <strong>4,8/5</strong> mii de clienți mulțumiți</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-revs">
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Somnul pe o parte</p>
      <h2 class="ncd-h2">Recuperează diminețile pe care le credeai pierdute</h2>
      <p>Știi senzația: te trezești înțepenit, cauți toată noaptea o poziție care să nu doară sau te trezești de câteva ori fără motiv.</p>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Alinierea pe care o simți dimineața</h2>
      ...
      <ul class="ncd-check">
        <li>Coloană aliniată în loc de răsucită</li>
        <li>Bazin aliniat, fără răsucire</li>
        <li>Genunchi separați, fără presiune</li>
      </ul>
    </div>
...
<?php
$cd_cases = array(
  array( 'cld-case-bok.webp',       'Somnul pe o parte', 'Prilagođeno vašem prirodnom položaju.' ),
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Conceput pentru ce te împiedică să dormi</h2>
    <p class="ncd-sub">Șase situații în care perna pentru genunchi face cea mai mare diferență.</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-cases">
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Creată să respire</h2>
      <p>Spumă cu memorie de calitate medicală, cu perforații integrate — suficient de fermă cât să mențină distanța, suficient de moale cât să se muleze pe corp.</p>
      <ul class="ncd-check">
        <li><strong>Husă lavabilă</strong> — material respirabil, blând cu pielea</li>
        <li><strong>Perforațiile</strong> mențin spuma proaspătă toată noaptea</li>
        <li><strong>Își păstrează forma</strong> ani la rând, nu se turtește</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Nu toate pernele pentru genunchi sunt la fel</h2>
      <ul class="ncd-vs">
        <li class="is-no"><strong>Fără bandă</strong><span>cade imediat ce te întorci</span></li>
        <li class="is-no"><strong>Gaura centrală</strong><span>împiedică circulația</span></li>
        <li class="is-no"><strong>Se turtește</strong><span>în câteva săptămâni</span></li>
        <li class="is-yes"><strong>Bandă reglabilă</strong><span>rămâne exact unde trebuie</span></li>
        <li class="is-yes"><strong>Formă plină, ergonomică</strong><span>fără găuri și goluri</span></li>
        <li class="is-yes"><strong>Spumă de calitate medicală</strong><span>își păstrează forma ani la rând</span></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Fabricată după standarde stricte</h2>
      <p>Materialele sunt testate pentru substanțe nocive, iar spuma este certificată. Designul respectă standardele elvețiene de calitate.</p>
      <ul class="ncd-check">
        <li><strong>OEKO-TEX® STANDARD 100</strong> — fără substanțe nocive</li>
        <li><strong>CertiPUR-EU</strong> — spumă cu memorie certificată</li>
        <li><strong>Proiectat în Elveția</strong>, fabricat după standarde europene</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Fără riscuri</p>
      <h2 class="ncd-h2">60 de nopți de probă</h2>
      <p>Încearc-o singur. Dacă NORIKS Cloud nu e pentru tine, îți returnăm toată suma — fără condiții și fără hârtii.</p>
      <a class="ncd-cta" href="#bundle-selector">Comandă NORIKS Cloud</a>
    </div>
    <div class="ncd-media"><?php echo $cd_img('cld-60-noci.webp','60 de nopți de probă'); ?></div>
  </div>
</section>
