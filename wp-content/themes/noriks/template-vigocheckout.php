...
<div class="vigo-checkout-total order-total shop_table woocommerce-checkout-review-order-table">
    ...
    <div class="flex__item--autosize f--m checkout-warranty__text">
        ...
        Returnarea banilor posibilă în termen de 14 de zile    </div>
</div>
...
<p class="ql-align-justify">Nakon predaje izjave o odustajanju, svoje produse morate vratiti u roku od 14 dana od datuma izjave o odustajanju. Robu pošaljite na našu adresu: <strong>HS PLUS d.o.o., Poštanska ulica 25, 10410 Velika Gorica</strong>.&nbsp;Smatra se da je roba pravovremeno vraćena ako je pošaljete prije isteka roka za povrat u trajanju od 14 dana.&nbsp;Morate vratiti neizmijenjenu količinu neoštećenih produsului, zapakiranih u originalno pakiranje ili ambalažu koja produse štiti na isti način kao i originalna ambalaža. Ne možete vratiti oštećene produse, produse u izmijenjenoj količini ili produse upakirane u neprikladnu ambalažu. Molimo vratite artikle kao paketnu pošiljku, a ne kao pismo, osiguravajući da je paket označen kodom za odustanak od kupnje, koji ćete dobiti tijekom postupka.Ako paket nije pravilno označen (poslan bez koda za odustanak od kupnje), to može značajno produžiti vrijeme potrebno za obradu vašeg zahtjeva. U slučaju odustajanja od ugovora, podmirit ćete samo troškove povrata robe, s tim da se navedeni troškovi ne mogu nadoknaditi.</p>
...
<p class="ql-align-justify"><strong>UPOZORENJE: </strong>Ako dobrovoljno vratite produs za koji nije moguće odstupanje od kupnje,&nbsp;nakon perioda za povrat od 14 dana, nakon 14 dana od obavijesti o odstupanju od kupnje, koji nije kupljen u našoj trgovini Takav Vam produs možemo vratiti natrag isključivo uz naplatu 10 EUR što predstavlja trošak obrade neopravdane reklamacije. Produs koji nije preuzet bit će uništen nakon 2 mjeseca.</p>
...
<p class="ql-align-justify">Od kupnje možete odustati u roku&nbsp;<strong>od 14 dana od isporuke, </strong>bez navođenja razloga. Morate vratiti produs na našu adresu da biste mogli zatražiti zamjenu za drugi produs ili povrat novca za produs. Rok za odustajanje od kupnje istječe 14 dana nakon kada vi ili treća strana koju ste odredili, a koja nije prevoznik, fizički preuzmu robu.</p>
...
<p class="ql-align-justify"><strong>U roku 14 dana od isporuke možete ispuniti</strong>&nbsp;obrazac na poveznici za zamjenu produsului&nbsp;ili&nbsp;povrat novca<strong>&nbsp;ILI&nbsp;</strong>možete nas obavijestiti e-poštom o namjeri da odustajete od kupnje.</p>
