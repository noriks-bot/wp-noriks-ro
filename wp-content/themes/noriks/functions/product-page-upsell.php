	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Afișează upsell sub buton (3x Boxeri Albaștri)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Adaugă caseta "Cumpără împreună și economisește" imediat sub butonul Adaugă în coș. Clientul alege mărimea, iar 3 bucăți se adaugă la prețul de upsell. Valabil doar pentru acest produs.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'total'      => 74.97,                   // ista cijena kao thank you upsell (3 x 4,99)
		'title'      => '3x Boxeri Albaștri',
