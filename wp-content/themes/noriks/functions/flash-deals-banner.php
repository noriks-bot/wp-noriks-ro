...
const NORIKS_FLASH_CAT   = 'reduceri-de-vara';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Reduceri de vară">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Reducere de sezon</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Reduceri de vară</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Redus în limita stocului</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Oferta expiră în</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>zile</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>ore</em></span>
            <span class="nfd-unit"><b data-u="m">00</b><em>min</em></span>
            <span class="nfd-unit"><b data-u="s">00</b><em>sec</em></span>
          </div>
        </div>
      </div>
    </div>
