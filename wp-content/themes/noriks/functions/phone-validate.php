 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+40...),
 * ker je Metakocka del narocil zavracala samo zaradi presledkov in oklepajev.
 */

if ( ! defined( 'ABSPATH' ) ) { exit; }

define( 'NORIKS_TEL_CC',    '40' );
...
add_action( 'woocommerce_checkout_process', function () {
    ...
    if ( $p !== '' && ! noriks_tel_ok( $p ) ) {
        wc_add_notice( 'Verificați numărul de telefon — pare incomplet.', 'error' );
    }
}, 5 );
...
add_action( 'wp_footer', function () {
    ...
    jQuery(function($){
      var CC = '40', TRUNK = '0', MIN = 9, MAX = 13;
      var MSG = <?php echo wp_json_encode( 'Verificați numărul de telefon — pare incomplet.' . ' ' . 'ex. 0744 223 528' ); ?>;
