...
add_action( 'wp_footer', function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  if (!btn) return;
	  btn.textContent = 'Înapoi la selecție';
...
function noriks_controlpro_atc_testimonial() {
    ...
    <div class="cpr-atc-rev">
        <img class="cpr-atc-avatar" src="<?php echo esc_url( $avatar ); ?>" alt="Client mulțumit NORIKS ControlPro" loading="lazy">
        <div class="cpr-atc-body">
            <p class="cpr-atc-text">„După operația de prostată am făcut constant exerciții Kegel timp de doi ani și nu am văzut progrese notabile. Credeam că voi purta absorbante toată viața. Patru săptămâni cu acest aparat și de la 5 absorbante pe zi am ajuns la zero."</p>
