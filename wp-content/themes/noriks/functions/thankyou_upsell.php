...
function noriks_handle_add_upsell() {
    ...
    $bokserice_prices = array( 1 => 24.99, 3 => 74.97, 5 => 124.96 );
    $majice_prices    = array( 1 => 65.99, 3 => 149.99, 6 => 199.99 );
    ...
    $is_majice = ( strpos($cat_str, 'tricou') !== false || strpos($name, 'tricou') !== false );
