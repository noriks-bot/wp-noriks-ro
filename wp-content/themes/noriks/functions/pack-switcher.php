 ...
 *   RO  set-6-tricouri    (parinte: tricouri)
...
function noriks_render_pack_switcher() {
    ...
    <div class="npk">
        ...
        <?php if ( $shown > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Alege pachetul', 'noriks' ); ?></div>
                    ...
                    <a class="npk-size<?php echo $is_cur ? ' is-active' : ''; ?>"
                       ...
                       <?php echo $is_cur ? 'aria-current="true"' : ''; ?>>
                        <span class="npk-size-n"><?php
                            if ( (int) $s === 1 ) {
                                esc_html_e( '1 buc.', 'noriks' );
                            } else {
                                echo (int) $s; ?> <?php esc_html_e( 'buc.', 'noriks' );
                            } ?></span>
                        <span class="npk-size-p"><?php echo wp_kses_post( wc_price( $ppu ) ); ?><span class="npk-size-u"><?php esc_html_e( '/ buc.', 'noriks' ); ?></span></span>
                    </a>
                <?php endforeach; ?>
            </div>
        ...
        <?php if ( count( $same ) > 1 ) : ?>
        <div class="npk-block">
            <div class="npk-label"><?php esc_html_e( 'Culoare', 'noriks' ); ?></div>
            <div class="npk-scroll">
