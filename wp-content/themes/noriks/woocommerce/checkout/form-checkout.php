...
<form name="checkout" method="post" class="checkout woocommerce-checkout"
      action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" aria-label="Plată">
      ...
      <div class="woocommerce-additional-fields">
        ...
        <div id="custom_shipping">
              ...
              <label for="shipping_method_0_standard_custom" class="checkedlabel">
                ...
                <div class="outer-wrapper">
                  ...
                  <div class="inner-wrapper-img">
                    <span class="shipping_method_delivery_price tag tag--red"><?php $ship = (float) WC()->cart->get_shipping_total(); echo $ship > 0 ? wc_price($ship) : 'Gratuit'; ?></span>
          ...
          <div class="delivery-from-eu-warehouse">
            ...
            <span class="delivery-from-eu-warehouse__text">Depozit în UE</span>
          </div>
        </div>
        ...
        <h3 class="payment-title">Metodă de plată</h3>
...
<div class="checkout-warranty flex flex--center flex--middle">
  ...
  <div class="flex__item--autosize f--m checkout-warranty__text">
    <strong>Cumpărați fără griji </strong><br>Returnarea banilor este posibilă în termen de 30 de zile
  </div>
</div>

<!-- Terms -->
<div class="agreed_terms_txt">
  <span class="policy-agreement-obligation">Apăsând butonul <strong>Comandă</strong> confirm comanda cu obligația de plată.</span><br>
  <div class="terms-checkbox-and-links">
    ...
    Am citit și accept <a href="#" id="terms_conditions_link">Termenii și condițiile generale de vânzare</a> și <a href="#" id="withdrawal_policy_link">dreptul de retragere</a>.
  </div>
</div>
