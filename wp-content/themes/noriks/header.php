...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      <span><a href="/ro/shop">Livrare gratuită pentru comenzi de peste 350 lei</a></span>
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/ro/shop">Creează-ți pachetul</a>
                        <a href="/ro/product-category/bundles/">Pachete gata pregătite</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/ro/product-category/bokserice-sastavi-paket/">Creează-ți pachetul</a>
                        <a href="/ro/product-category/bokserice/">Pachete gata pregătite</a>
                    </div>
                    -->
                </div>
