<?php
/**
 * Template Name: Instrucțiuni de utilizare
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Descarcă instrucțiunile pentru produsul tău NORIKS în format PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Caută după numele produsului…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Descarcă PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Pagina produsului</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Nu există instrucțiuni pentru acest termen. Scrie-ne la <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Ai nevoie de ajutor cu produsul? Scrie-ne la <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
